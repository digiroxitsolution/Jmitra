...
@section('title', 'Sale Pax | Jmitra & Co. Pvt. Ltd')
@section('content') 
<!--*******************
            Main Content start
        *******************-->
            ...
            <div class="row my-5">
                <div class="col">
                    <div class="d-grid d-flex justify-content-end">
                        <h5 class="text-info mt-2 me-3">Total PAX
                        ...
                        <form action="{{ route('sale_pax') }}" method="POST">
                            @csrf
            ...
            <div class="row my-5">
                <div class="border table-header p-4 position-relative rounded-top-4">
                            <div class="d-flex justify-content-between">
                                ...
                                <form action="{{ route('pax_print') }}" method="POST">                  
                                    @csrf
                                <input type="month" name="monthName" id="monthName" class="form-control" hidden>
        ...
        plugins: [ChartDataLabels,
            {
                ...
                afterRender: function(chart) {
                    setTimeout(() => {
                        ...
                        fetch('{{ route('save_pax_chart_image') }}', {
                            method: 'POST',
                            headers: {
