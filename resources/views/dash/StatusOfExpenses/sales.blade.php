<!-- Display the table for 'Sales' role -->
						    <table id="example" class="table bg-white rounded shadow-sm table-hover">
						        ...
						        <tbody>
						            ...
						            <tr>
						                <td>{{ $i++ }}</td>
						                <td>{{ Auth::user()->userDetail->employee_id ?? 'N/A' }}</td>
						                <td>{{ Auth::user()->name ?? 'N/A' }}</td>
						                <td>{{ $monthly_expense->user->userDetail->hod->name ?? 'N/A' }}</td>
						                <td>{{ Auth::user()->userDetail->companyMaster->company_name ?? 'N/A' }}</td>
						                <td>{{ Auth::user()->userDetail->locationMaster->working_location ?? 'N/A' }}</td>
