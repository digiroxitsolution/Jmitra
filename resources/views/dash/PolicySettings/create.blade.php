				  ...
				  <div class="modal-dialog modal-dialog-centered modal-xl">
				    <div class="modal-content">
				      <div class="modal-header">
				        <h5 class="modal-title">New Policy Setting</h5>
				        <button type="button" class="btn-close bg-light" data-bs-dismiss="modal" aria-label="Close"></button>
				      </div>
				      <form class="p-4" action="{{ route('policy_settings.store') }}" method="POST" id="policyForm">
					    @csrf
					    ...
					    <div class="modal-body">
					        ...
					        <div class="row mb-4">
					            <div class="col-lg-4 col-12 mb-lg-0 mb-3">
					                ...
					                <input type="text" class="form-control" id="policy_name" name="policy_name" placeholder="Policy Name" required>
					            ...
					            <div class="col-lg-4 col-12 mb-lg-0 mb-3">
					                ...
					                <input type="date" class="form-control" id="effective_date" name="effective_date" placeholder="Policy Name" required>
					        ...
					        <div class="row mb-4">
					            <div class="col-lg-4 col-12 mb-lg-0 mb-3">
					                ...
					                <input type="number" class="form-control no-negative" id="location_da" name="location_da" placeholder="Location DA" required>
					            ...
					            <div class="col-lg-4 col-12 mb-lg-0 mb-3">
					                ...
					                <input type="number" class="form-control no-negative" id="ex_location_da" name="ex_location_da" placeholder="Ex-Location DA" required>
					            ...
					            <div class="col-lg-4 col-12 mb-lg-0 mb-3">
					                ...
					                <input type="number" class="form-control no-negative" id="outstation_da" name="outstation_da" placeholder="Outstation DA" required>
					        ...
					        <div class="row mb-4">
					            <div class="col-lg-4 col-12 mb-lg-0 mb-3">
					                ...
					                <input type="text" class="form-control" id="intercity_travel_ex_location" name="intercity_travel_ex_location" placeholder="Intercity Travel (Ex Location Only)" required>
					            ...
					            <div class="col-lg-4 col-12 mb-lg-0 mb-3">
					                ...
					                <input type="text" class="form-control" id="intercity_travel_outstation" name="intercity_travel_outstation" placeholder="Intercity Travel (Outstation)" required>
					        ...
					        <div class="row mb-4">
					            <div class="col-lg-4 col-12 mb-lg-0 mb-3">
					                ...
					                <input type="number" class="form-control" id="two_wheelers_charges" name="two_wheelers_charges" placeholder="Per KM Charges">
					            </div>

					            <div class="col-lg-4 col-12 mb-lg-0 mb-3">
					                <label for="charges" class="form-label">Four Wheeler Per KM Charges<span class="text-danger">*</span>:</label>
					                <input type="number" class="form-control" id="four_wheelers_charges" name="four_wheelers_charges" placeholder="Per KM Charges">
					            </div>
					    ...
					    <div class="modal-footer">
					        ...
					        <button type="submit" class="btn btn-primary">Add Policy Setting</button>
					    </div>
					</form>
				    </div>
				  </div>
