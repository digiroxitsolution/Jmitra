...
@section('title', 'Monthly Expense Fare | Jmitra & Co. Pvt. Ltd')
@section('content')	
<!--*******************
            Main Content start
        *******************-->
            ...
            <div class="row my-5">
                <div class="col">
                    <div class="d-grid d-flex justify-content-end">
                        <h5 class="text-info mt-2 me-3">Fare 
                        ...
                        <form action="{{ route('sale_fare') }}" method="POST">
                            @csrf
            ...
            <div class="row my-5">
                <div class="border table-header p-4 position-relative rounded-top-4">
                            <div class="d-flex justify-content-between">
                                <h5 class="text-white">Total Fare</h5>
                                <form action="{{ route('fare_print') }}" method="POST">                  
                                    @csrf
                ...
                <div class="container text-center">
                    ...
                    <div class="mb-4">
                        <h4 class="badge bg-primary p-3">FARE: {{ number_format($totalFare, 2) }}</h4>
                    </div>
        ...
        plugins: [ChartDataLabels,
            {
                ...
                afterRender: function(chart) {
                    setTimeout(() => {
                        ...
                        fetch('{{ route('save_fare_chart_image') }}', {
                            method: 'POST',
                            headers: {
